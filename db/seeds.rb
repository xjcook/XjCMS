...
User.create(:login => "redactor", :password => "redactor", :role => redactor)
User.create(:login => "user",  :password => "user",  :role => user)
User.create(:login => "guest",  :password => "guest",  :role => guest)
